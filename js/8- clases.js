...
class Serie {
  ...
  mostraDatos() {
    document.write(
      "Serie: " + this.nombre + " Temporadas: " + this.temporadas + "<br>"
    );
  }
  ...
  mostrarDatosExtendido() {
    ...
    document.write(
      `Serie: ${this.nombre}, tiene ${this.temporadas} temporadas, con ${this.capitulos} capitulos cada una. Genero ${this.genero}<br>  `
    );
  }
}
